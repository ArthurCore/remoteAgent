...
| AW-010A | channel stream foundation 추출 | coder | AW-008 | channel-local sequence state + canonical channel event journal | DONE |
| AW-009 | tenant/workspace/channel authenticated-shell preview | coder | AW-008, AW-010A | tenant-bound API+Web E2E | READY (code unblocked; implementation next) |
