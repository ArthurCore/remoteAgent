...
- Exact constraints: `channel_events_event_id_key`, `channel_events_event_seq_check`, `channel_events_schema_version_check`, and `channel_events_event_type_check` over the frozen seven literals.
